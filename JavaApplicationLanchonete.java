...
// |      1               | (1*2*50)/ 1000= 0.1   | (1*50)/1000=0.05      | (1*100)/1000=0.1  |
// |      5               | (5*2*50)/ 1000= 0.5   | (5*50)/1000=0.25      | (5*100)/1000=0.5  |
// |      10              | (10*2*50)/ 1000= 1.0  | (1*50)/1000=0.5       | (10*100)/1000=1.0 |
// |      15              | (15*2*50)/ 1000 = 1.5 | (5*50)/1000=075       | (15*100)/1000=1.5 |
